    ...
    <div id="page-container" class="fade">
        ...
        <div class="login login-v2" data-pageload-addclass="animated fadeIn">
            ...
            <div class="login-header">
                <div class="brand">
                    <span class="logo"></span> <b>DIKA</b> TMS
            ...
            <div class="login-content">
                <form role="form" action="" method="post" class="margin-bottom-0">
                    <div class="form-group m-b-20">
                        <input type="text" name="email_dika" class="form-control form-control-lg" placeholder="Email" required autofocus />
                        <?php echo "<p>" . form_error('email_dika') . "</p>"; ?>
                    </div>
