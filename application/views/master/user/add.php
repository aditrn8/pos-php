        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="username" id="username" class="form-control" value="<?= set_value('username') ?>" autocomplete="off">
                    <?= form_error('username', '<small class="text-danger">', '</small>') ?>
                </div>

                <div class="form-group">
                    <label for="">Password : <code>*</code></label>
                    <input type="text" name="password" id="password" class="form-control" value="<?= set_value('password') ?>" autocomplete="off">
                    <?= form_error('password', '<small class="text-danger">', '</small>') ?>
                </div>

                <div class="form-group">
                    <label for="">No Telepon : <code>*</code></label>
                    <input type="number" name="phone" id="phone" class="form-control" value="<?= set_value('phone') ?>" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <select name="role" class="form-control">
                        ...
                        <?php foreach ($masterRole->result() as $mr) { ?>
                            <option value="<?= $mr->role_id ?>" <?= set_select('role', $mr->role_id) ?>><?= $mr->role_description ?></option>
                        <?php } ?>
                    </select>
